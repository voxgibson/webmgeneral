# WEBM GENERAL CONVERTER v2.0 LINUX #
...
def start():
    ...
    # Removes nul if it already exist. 
    try:
        os.remove('nul')
...
metadata_ent = Entry(fg='#0f0c5d', width=59)
...
Label(text='Converter v2.0', font='Arial 13 bold', fg='#789922', bg='#EEF2FF').grid(row=0, column=4, sticky='W')
